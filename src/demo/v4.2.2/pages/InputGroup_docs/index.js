...
render() {
  ...
  <NavPageContainer
    ...
    <h1>InputText</h1>
    <p className="font-size-18px">The <span className="app-color-primary">Input</span> element is used to create interactive controls for forms in order to accept data from the user.</p>
